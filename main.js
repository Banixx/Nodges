 ...
 * 
 * Features:
 * - 8 Layout Algorithms (Force-Directed, Fruchterman-Reingold, etc.)
...
class NodgesApp {
    ...
    async initManagers() {
        ...
        this.edgeLabelManager = new EdgeLabelManager();
    ...
    initFileInfoPanel() {
        // File info panel is already in HTML
    ...
    focusOnNode(nodeData) {
        ...
        if (nodeObject && nodeObject.mesh) {
            ...
            // Simple camera animation (could be enhanced with TWEEN.js)
    ...
    animate() {
        ...
        // Update state manager (for glow effects)
