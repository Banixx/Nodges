...
## Schritt 2: Die 3 Säulen eines Nodges-Graphen
...
Um Nodges überhaupt erst etwas zeichnen zu lassen, laden wir (beispielsweise per Drag&Drop oder intern aus dem Store) strukturierte Daten. Hier ist ein Graph mit genau "2 Punkten und einer Verbindung":
...
Wenn diese Datei auf die Leinwand gezogen wird, feuert der **ImportManager**. Er jagt das JSON durch die Zod-Typen. Ist alles valide, reicht er es weiter.

## Schritt 3: Der Weg vom Upload zum Bildschirm (Life-Cycle)
...
## Schritt 4: Einfache Eingriffe in den Code
...
---
*Dokumentations-Status: V2.0 (Quickstart)*
