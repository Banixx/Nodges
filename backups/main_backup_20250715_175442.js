...
class NodgesApp {
    constructor() {
        console.log(' Initialisiere Nodges 0.87');
    ...
    async init() {
        try {
            ...
            console.log(' Nodges 0.86 erfolgreich initialisiert');
    ...
    createGround() {
        ...
        // Optional: Gitter-Linien für bessere Orientierung
    ...
    createGridLines() {
        // Erstelle Gitter für bessere räumliche Orientierung
        const gridHelper = new THREE.GridHelper(100, 20, 0x444444, 0x222222);
        gridHelper.position.y = -4.9; // Knapp über dem Untergrund
        gridHelper.material.transparent = true;
        gridHelper.material.opacity = 0.3;
        this.scene.add(gridHelper);

        // Achsen-Helper für Orientierung
