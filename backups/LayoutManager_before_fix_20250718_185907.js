/**
 * LayoutManager - Zentrale Verwaltung aller Layout-Algorithmen fuer Nodges 0.88
 */
...
export class LayoutManager {
    ...
    registerDefaultLayouts() {
        ...
        this.registerLayout('fruchterman-reingold', {
            ...
            apply: (nodes, edges) => this.applyFruchtermanReingoldLayout(nodes, edges),
            options: {
                maxIterations: 500,
                area: 400,
                temperature: 10
        ...
        this.registerLayout('spring-embedder', {
            ...
            apply: (nodes, edges) => this.applySpringEmbedderLayout(nodes, edges),
            options: {
                maxIterations: 1000,
                springConstant: 0.1,
        ...
        this.registerLayout('hierarchical', {
            name: 'Hierarchical',
            apply: (nodes, edges) => this.applyHierarchicalLayout(nodes, edges),
            options: {
                levelHeight: 3,
                nodeSpacing: 2
            }
        ...
        this.registerLayout('tree', {
            name: 'Tree',
            apply: (nodes, edges) => this.applyTreeLayout(nodes, edges),
            options: {
                levelHeight: 3,
                nodeSpacing: 2
            }
    ...
    applyForceLayout(nodes, edges, options) {
        const { maxIterations, repulsionStrength, attractionStrength, damping } = options;
    ...
    applyFruchtermanReingoldLayout(nodes, edges, options) {
        const { maxIterations, area, temperature } = options;
