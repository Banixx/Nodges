...
export function addGridHelpers(scene) {
    ...
    const c1 = new THREE.Color(0x125634 ); // Bordeaux für Mittellinien
    const c2 = new THREE.Color(0x561234); // Ein passendes Blau für Gitterlinien
    const c3 = new THREE.Color(0x563412); // Ein dezentes Grün für Gitterlinien
